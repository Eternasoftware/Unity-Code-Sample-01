...
{
    public class ClosetDecorPlaceTargetSensor : LocalTargetSensorBase, IInjectable
    {
        ...
        {
            var closet = aiGeneralGameplayBlackboard.GetClosetDecorPlace(agent.transform.position);
            if (closet is null)
                return null;
