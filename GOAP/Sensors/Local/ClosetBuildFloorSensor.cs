...
{
    public class ClosetBuildFloorSensor : LocalTargetSensorBase, IInjectable
    {
        ...
        {
            var closet = aiGeneralGameplayBlackboard.GetClosetFloorBuild(agent.transform.position);
            if (closet is null)
                return null;
