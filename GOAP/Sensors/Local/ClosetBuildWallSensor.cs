...
{
    public class ClosetBuildWallSensor : LocalTargetSensorBase, IInjectable
    {
        ...
        {
            var closet = aiGeneralGameplayBlackboard.GetClosetBuildWall(agent.transform.position);
            if (closet is null)
                return null;
