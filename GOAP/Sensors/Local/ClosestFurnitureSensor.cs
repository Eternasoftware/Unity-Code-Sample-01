...
{
    public class ClosestFurnitureSensor : LocalTargetSensorBase, IInjectable
    {
        ...
        {
            var closet = aiGeneralGameplayBlackboard.GetClosetFurniture(agent.transform.position);
            if (closet is null)
                return null;
