...
{
    public class HasBushSensor : LocalWorldSensorBase, IInjectable
    {
        ...
        {
            if (aiGeneralGameplayBlackboard.cacheState == IDStateGame.bushCutting && !gameplayComponent.IsProgressMax())
            {
                return answer[1];
            }
            return answer[0];
