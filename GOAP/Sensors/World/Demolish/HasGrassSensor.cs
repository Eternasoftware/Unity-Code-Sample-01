...
{
    public class HasGrassSensor : LocalWorldSensorBase, IInjectable
    {
        ...
        {
            if (aiGeneralGameplayBlackboard.cacheState != IDStateGame.grassCutting 
                && aiGeneralGameplayBlackboard.cacheState != IDStateGame.tractor)
            {
                return answer[0];
            }
