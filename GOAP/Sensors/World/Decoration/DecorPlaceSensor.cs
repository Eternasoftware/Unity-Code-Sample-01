...
namespace _GameData_.Scripts.Entities.AI.GOAP.Sensors.World
{
    public class DecorPlaceSensor : LocalWorldSensorBase, IInjectable
    {
        ...
        {
            if (aiGeneralGameplayBlackboard.HasPlaceToDecor())
            {
                return answer[1];
            }
            return answer[0];
